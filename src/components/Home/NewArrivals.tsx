    ...
    <section className="w-full mt-8 lg:mt-10 lg:grid-row-2 lg:min-h-screen space-y-8">
      <div className="flex">
        <motion.div
          ...
          viewport={{ once: true }}
          className="justify-start w-max col-span-2 row-auto items-start h-max"
        >
          <div className="flex items-center justify-start lg:h-max mr-4">
            <icons.arrowDown className="animate-bounce h-24 w-32 md:h-20 md:w-24" />
            <h1 className="transition-opacity font-bold text-5xl lg:text-6xl lg:whitespace-nowrap">
              New Arrivals
            </h1>
          </div>
        </motion.div>
      ...
      <div className="col-span-6">
        <motion.div
          ...
          viewport={{ once: true }}
          className="grid grid-cols-1 rows-auto sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-full mt-12 sm:mt-4"
        >
